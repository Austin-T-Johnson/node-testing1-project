...
describe('[Exercise 3] findLargestInteger', () => {
    test('[5] returns the largest number in an array of objects { integer: 2 }', () => {
        let input = [{ integer: 12 }, { interger: 4 }, { integer: 10 },]
        let input2 = [{ integer: 112 }, { interger: 14 }, { integer: 110 },]
        let input3 = [{ integer: 12 }, { interger: 4 }, { integer: 1110 },]
